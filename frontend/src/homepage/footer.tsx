...
function footer() {
  return (
    <footer className="bg-[#3B5236] text-white py-5 px-4 sm:px-8 md:px-16 font-nunito ">
      ...
      {/* Container */}
      <div className="grid grid-cols-1 lg:grid-cols-3 justify-between space-y-4 md:space-y-0">
        {/* Left Section */}
        <div className=" flex  sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2  space-x-4 items-center p-4 ">
          <a className="flex h-20 w-20 ml-3 text-gray-500">
            <img src="public/Footer-truck.svg" />
      ...
      <div className="flex flex-wrap justify-between space-y-4 md:space-y-0">
        ...
        <div className="lg:w-1/4 md:w-1/2 w-full p-4 ">
          ...
          <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap items-end justify-start">
            <div className='relative flex items-center'>
              ...
              />
              <FaArrowRightLong className='absolute right-0 m-2 hover:cursor-pointer text-black' />
            </div>
          </div>
